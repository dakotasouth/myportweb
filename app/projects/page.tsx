export default function Page() {
    return (
        <section className="min-w-0 m-auto mx-auto max-w-7xl font-inter">
            ...
            <div className="py-5">
                <h3 className='text-3xl font-bold underline text-primary'><a href="https://weaversolver.tech/" target="_blank">Weaver Solver</a></h3>
            ...
            <div className="py-5">
                <h3 className='text-3xl font-bold underline text-primary'><a href="https://github.com/dakotasouth/stock-ticker-search" target="_blank">Stock Ticker Search</a></h3>
                <div className="py-2 text-2xl text-secondary font-inter">
            ...
            <div className="py-5">
                <h3 className='text-3xl font-bold underline text-primary'><a href="https://github.com/dakotasouth/shared-pages-chrome-extension" target="_blank">Annotate Chrome Extension</a></h3>
                <div className="py-2 text-2xl text-secondary font-inter">
